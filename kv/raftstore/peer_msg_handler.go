...
func (d *peerMsgHandler) applyAdminEntry(raftCmdRequest raft_cmdpb.RaftCmdRequest, kvWB *engine_util.WriteBatch, appliedIndex uint64, cb *message.Callback, resp *raft_cmdpb.RaftCmdResponse) {
	...
	case raft_cmdpb.AdminCmdType_ChangePeer:
		...
		storeMeta.setRegion(curRegion, d.peer)
...
func (d *peerMsgHandler) applyNormalEntry(raftCmdRequest raft_cmdpb.RaftCmdRequest, kvWB *engine_util.WriteBatch, appliedIndex uint64, cb *message.Callback, resp *raft_cmdpb.RaftCmdResponse) {
...
func (d *peerMsgHandler) applyEntry(entry *eraftpb.Entry, cb *message.Callback){
	...
	if raftCmdRequest.AdminRequest != nil {
		...
		d.applyNormalEntry(raftCmdRequest, kvWB, entry.Index, cb, resp)
	}
}
